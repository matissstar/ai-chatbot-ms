...
class Bootflow_Shop_Assist_Admin {
    ...
    public function register_settings() {
        ...
        // Appearance settings
        register_setting('ai_chatboot_ms_settings', 'ai_chatboot_ms_color_palette', [
            'type' => 'string',
            'default' => 'indigo',
            'sanitize_callback' => 'sanitize_text_field',
        ]);
        register_setting('ai_chatboot_ms_settings', 'ai_chatboot_ms_custom_primary', [
            'type' => 'string',
            'default' => '',
            'sanitize_callback' => 'sanitize_hex_color',
        ]);
        register_setting('ai_chatboot_ms_settings', 'ai_chatboot_ms_custom_text', [
            'type' => 'string',
            'default' => '',
            'sanitize_callback' => 'sanitize_hex_color',
        ]);
        register_setting('ai_chatboot_ms_settings', 'ai_chatboot_ms_custom_bg', [
            'type' => 'string',
            'default' => '',
            'sanitize_callback' => 'sanitize_hex_color',
        ]);
        // Button color settings
        register_setting('ai_chatboot_ms_settings', 'ai_chatboot_ms_color_details', [
            'type' => 'string',
            'default' => '',
            'sanitize_callback' => 'sanitize_hex_color',
        ]);
        register_setting('ai_chatboot_ms_settings', 'ai_chatboot_ms_color_compare', [
            'type' => 'string',
            'default' => '',
            'sanitize_callback' => 'sanitize_hex_color',
        ]);
        register_setting('ai_chatboot_ms_settings', 'ai_chatboot_ms_color_cart', [
            'type' => 'string',
            'default' => '',
            'sanitize_callback' => 'sanitize_hex_color',
        ]);
        register_setting('ai_chatboot_ms_settings', 'ai_chatboot_ms_font', [
            'type' => 'string',
            'default' => 'Inter',
            'sanitize_callback' => 'sanitize_text_field',
        ]);
        register_setting('ai_chatboot_ms_settings', 'ai_chatboot_ms_font_size', [
            'type' => 'string',
            'default' => '14',
        ...
        register_setting('ai_chatboot_ms_settings', 'ai_chatboot_ms_font_style', [
            'type' => 'string',
            'default' => 'normal',
            'sanitize_callback' => function($val) {
        ...
        register_setting('ai_chatboot_ms_settings', 'ai_chatboot_ms_voice_mode', [
            'type' => 'string',
            'default' => 'delayed',
            'sanitize_callback' => function($val) {
        ...
        register_setting('ai_chatboot_ms_settings', 'ai_chatboot_ms_voice_silence', [
            'type' => 'integer',
            'default' => 4,
            'sanitize_callback' => function($val) {
                $val = intval($val);
        ...
        register_setting('ai_chatboot_ms_settings', 'ai_chatboot_ms_show_default_starters', [
            'type' => 'string',
            'default' => '1',
            'sanitize_callback' => function($val) {
                return $val ? '1' : '0';
        ...
        register_setting('ai_chatboot_ms_settings', 'ai_chatboot_ms_gdpr_notice', [
            'type' => 'string',
            'default' => '',
            'sanitize_callback' => 'wp_kses_post',
        ]);
        register_setting('ai_chatboot_ms_settings', 'ai_chatboot_ms_auto_contact', [
            'type' => 'string',
            'default' => '1',
            'sanitize_callback' => function($val) {
                return $val ? '1' : '0';
        ...
        register_setting('ai_chatboot_ms_settings', 'ai_chatboot_ms_wl_name', [
            'type' => 'string',
            'default' => '',
            'sanitize_callback' => 'sanitize_text_field',
        ]);
        register_setting('ai_chatboot_ms_settings', 'ai_chatboot_ms_wl_icon', [
            'type' => 'string',
            'default' => '',
            'sanitize_callback' => 'sanitize_text_field',
        ]);
        register_setting('ai_chatboot_ms_settings', 'ai_chatboot_ms_wl_welcome', [
            'type' => 'string',
            'default' => '',
            'sanitize_callback' => 'sanitize_text_field',
        ]);
        register_setting('ai_chatboot_ms_settings', 'ai_chatboot_ms_wl_admin_name', [
            'type' => 'string',
            'default' => '',
            'sanitize_callback' => 'sanitize_text_field',
        ]);
        register_setting('ai_chatboot_ms_settings', 'ai_chatboot_ms_wl_powered_by', [
            'type' => 'string',
            'default' => '1',
            'sanitize_callback' => function($val) {
                return $val ? '1' : '0';
        ...
        // Handoff settings
        register_setting('ai_chatboot_ms_settings', 'ai_chatboot_ms_handoff_enabled', [
            'type' => 'string',
            'default' => '0',
            'sanitize_callback' => function($val) {
                return $val ? '1' : '0';
        ...
        register_setting('ai_chatboot_ms_settings', 'ai_chatboot_ms_handoff_context', [
            'type' => 'string',
            'default' => '1',
            'sanitize_callback' => function($val) {
                return $val ? '1' : '0';
        ...
        register_setting('ai_chatboot_ms_settings', 'ai_chatboot_ms_handoff_methods', [
            'type' => 'string',
            'default' => '[]',
            'sanitize_callback' => function($val) {
                if (is_string($val)) {
    ...
    public function handle_export_products() {
        ...
        if ($bootflow_shop_assist_chatbot && method_exists($bootflow_shop_assist_chatbot, 'export_products_to_json')) {
            ...
            if ($result) {
                ...
                add_settings_error('ai_chatboot_ms_messages', 'export_error', ai_chatboot_ms_t('admin_export_error'), 'error');
            }
        }
    ...
    public function page_responses() {
        ...
        ?>
        <div class="wrap">
            <h1><?php echo esc_html($wl_admin_name); ?> — <?php echo esc_html(ai_chatboot_ms_t('admin_tab_responses')); ?></h1>
    ...
    public function page_settings() {
        ...
        ?>
        <div class="wrap">
            <h1><?php echo esc_html($wl_admin_name); ?> — <?php echo esc_html(ai_chatboot_ms_t('admin_tab_settings')); ?></h1>
    ...
    private function render_settings_tab() {
        ...
        ?>
            ...
            <form method="post" action="options.php">
                <?php settings_fields('ai_chatboot_ms_settings'); ?>
                <table class="form-table">
                    <tr>
                        <th><?php echo esc_html(ai_chatboot_ms_t('admin_interface_lang')); ?></th>
                        <td>
                            <select name="ai_chatboot_ms_language">
                            ...
                            <p class="description"><?php echo esc_html(ai_chatboot_ms_t('admin_lang_desc')); ?></p>
                            <p class="description"><?php echo esc_html(ai_chatboot_ms_t('admin_active_label')); ?> <strong><?php echo esc_html($active_lang); ?></strong></p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <th><?php echo esc_html(ai_chatboot_ms_t('admin_excluded_tags')); ?></th>
                        <td>
                            <input type="text" name="ai_chatboot_ms_excluded_tags" value="<?php echo esc_attr(get_option('ai_chatboot_ms_excluded_tags', '')); ?>" class="regular-text" />
                            <p class="description"><?php echo esc_html(ai_chatboot_ms_t('admin_excluded_tags_desc')); ?></p>
                        </td>
                    </tr>
                    <tr>
                        <th><?php echo esc_html(ai_chatboot_ms_t('admin_show_default_starters')); ?></th>
                        <td>
                            <label>
                                <input type="checkbox" name="ai_chatboot_ms_show_default_starters" value="1" <?php checked(get_option('ai_chatboot_ms_show_default_starters', '1'), '1'); ?> />
                                <?php echo esc_html(ai_chatboot_ms_t('admin_show_default_starters_desc')); ?>
                            </label>
                        </td>
                    </tr>
                    <tr>
                        <th><?php echo esc_html(ai_chatboot_ms_t('admin_auto_contact')); ?></th>
                        <td>
                            <label>
                                <input type="checkbox" name="ai_chatboot_ms_auto_contact" value="1" <?php checked(get_option('ai_chatboot_ms_auto_contact', '1'), '1'); ?> />
                                <?php echo esc_html(ai_chatboot_ms_t('admin_auto_contact_desc')); ?>
                            </label>
                        </td>
                    </tr>
                </table>
                ...
                <hr>
                <h2>🎨 <?php echo esc_html(ai_chatboot_ms_t('admin_appearance')); ?></h2>
                ...
                $current_palette = get_option('ai_chatboot_ms_color_palette', 'indigo');
                $custom_primary = get_option('ai_chatboot_ms_custom_primary', '');
                $custom_text = get_option('ai_chatboot_ms_custom_text', '');
                $custom_bg = get_option('ai_chatboot_ms_custom_bg', '');
                $color_details = get_option('ai_chatboot_ms_color_details', '');
                $color_compare = get_option('ai_chatboot_ms_color_compare', '');
                $color_cart = get_option('ai_chatboot_ms_color_cart', '');
                $current_font = get_option('ai_chatboot_ms_font', 'Inter');
                $current_font_size = get_option('ai_chatboot_ms_font_size', '14');
                $current_font_style = get_option('ai_chatboot_ms_font_style', 'normal');
                ?>

                <table class="form-table">
                    <tr>
                        <th><?php echo esc_html(ai_chatboot_ms_t('admin_color_palette')); ?></th>
                        <td>
                            <div style="display:flex;gap:12px;flex-wrap:wrap;margin-bottom:10px">
                                <?php foreach ($palettes as $key => $pal): ?>
                                <label style="cursor:pointer;text-align:center">
                                    <input type="radio" name="ai_chatboot_ms_color_palette" value="<?php echo esc_attr($key); ?>" <?php checked($current_palette, $key); ?> style="display:none" class="msai-palette-radio">
                                ...
                                <?php endforeach; ?>
                                <label style="cursor:pointer;text-align:center">
                                    <input type="radio" name="ai_chatboot_ms_color_palette" value="custom" <?php checked($current_palette, 'custom'); ?> style="display:none" class="msai-palette-radio">
                    ...
                    <tr id="msai-custom-colors" style="<?php echo esc_attr($current_palette !== 'custom' ? 'display:none' : ''); ?>">
                        <th><?php echo esc_html(ai_chatboot_ms_t('admin_custom_colors')); ?></th>
                        <td>
                            <div style="display:flex;gap:20px;flex-wrap:wrap;align-items:center">
                                <label>
                                    <span style="display:block;font-size:13px;margin-bottom:4px"><?php echo esc_html(ai_chatboot_ms_t('admin_color_primary')); ?></span>
                                    <input type="color" name="ai_chatboot_ms_custom_primary" value="<?php echo esc_attr($custom_primary ?: '#6366f1'); ?>" style="width:50px;height:36px;cursor:pointer;border:1px solid #ccc;border-radius:6px">
                                </label>
                                <label>
                                    <span style="display:block;font-size:13px;margin-bottom:4px"><?php echo esc_html(ai_chatboot_ms_t('admin_color_text')); ?></span>
                                    <input type="color" name="ai_chatboot_ms_custom_text" value="<?php echo esc_attr($custom_text ?: '#1e293b'); ?>" style="width:50px;height:36px;cursor:pointer;border:1px solid #ccc;border-radius:6px">
                                </label>
                                <label>
                                    <span style="display:block;font-size:13px;margin-bottom:4px"><?php echo esc_html(ai_chatboot_ms_t('admin_color_bg')); ?></span>
                                    <input type="color" name="ai_chatboot_ms_custom_bg" value="<?php echo esc_attr($custom_bg ?: '#ffffff'); ?>" style="width:50px;height:36px;cursor:pointer;border:1px solid #ccc;border-radius:6px">
                                </label>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <th><?php echo esc_html(ai_chatboot_ms_t('admin_color_details')); ?></th>
                        <td>
                            <div style="display:flex;gap:20px;flex-wrap:wrap;align-items:flex-end">
                                <label>
                                    <span style="display:block;font-size:13px;margin-bottom:4px"><?php echo esc_html(ai_chatboot_ms_t('admin_color_details')); ?></span>
                                    <input type="color" name="ai_chatboot_ms_color_details" value="<?php echo esc_attr($color_details ?: '#64748b'); ?>" style="width:50px;height:36px;cursor:pointer;border:1px solid #ccc;border-radius:6px">
                                </label>
                                <label>
                                    <span style="display:block;font-size:13px;margin-bottom:4px"><?php echo esc_html(ai_chatboot_ms_t('admin_color_compare')); ?></span>
                                    <input type="color" name="ai_chatboot_ms_color_compare" value="<?php echo esc_attr($color_compare ?: '#f59e0b'); ?>" style="width:50px;height:36px;cursor:pointer;border:1px solid #ccc;border-radius:6px">
                                </label>
                                <label>
                                    <span style="display:block;font-size:13px;margin-bottom:4px"><?php echo esc_html(ai_chatboot_ms_t('admin_color_cart')); ?></span>
                                    <input type="color" name="ai_chatboot_ms_color_cart" value="<?php echo esc_attr($color_cart ?: '#059669'); ?>" style="width:50px;height:36px;cursor:pointer;border:1px solid #ccc;border-radius:6px">
                                </label>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <th><?php echo esc_html(ai_chatboot_ms_t('admin_font')); ?></th>
                        <td>
                            <?php
                            $fonts = [
                                'Inter'          => 'Inter',
                            ...
                            ?>
                            <select name="ai_chatboot_ms_font" id="msai_font_select">
                            ...
                            <span id="msai-font-preview" style="margin-left:16px;font-size:16px;"><?php echo esc_html(ai_chatboot_ms_t('admin_font_preview')); ?></span>
                        </td>
                    </tr>
                    <tr>
                        <th><?php echo esc_html(ai_chatboot_ms_t('admin_font_size')); ?></th>
                        <td>
                            <select name="ai_chatboot_ms_font_size" id="msai_font_size_select">
                    ...
                    <tr>
                        <th><?php echo esc_html(ai_chatboot_ms_t('admin_font_style')); ?></th>
                        <td>
                            <select name="ai_chatboot_ms_font_style" id="msai_font_style_select">
                                <option value="normal" <?php selected($current_font_style, 'normal'); ?>><?php echo esc_html(ai_chatboot_ms_t('admin_font_style_normal')); ?></option>
                                <option value="bold" <?php selected($current_font_style, 'bold'); ?>><?php echo esc_html(ai_chatboot_ms_t('admin_font_style_bold')); ?></option>
                                <option value="italic" <?php selected($current_font_style, 'italic'); ?>><?php echo esc_html(ai_chatboot_ms_t('admin_font_style_italic')); ?></option>
                            </select>
                        </td>
                    </tr>
                    <?php $current_voice_mode = get_option('ai_chatboot_ms_voice_mode', 'delayed'); ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <select name="ai_chatboot_ms_voice_mode">
                                ...
                                <option value="instant" <?php selected($current_voice_mode, 'instant'); ?>><?php echo esc_html(ai_chatboot_ms_t('admin_voice_mode_instant')); ?></option>
                            </select>
                            <p class="description"><?php echo esc_html(ai_chatboot_ms_t('admin_voice_mode_desc')); ?></p>
                        </td>
                    </tr>
                    <tr>
                        <th><?php echo esc_html(ai_chatboot_ms_t('admin_voice_silence')); ?></th>
                        <td>
                            <input type="number" name="ai_chatboot_ms_voice_silence" value="<?php echo esc_attr(get_option('ai_chatboot_ms_voice_silence', 4)); ?>" min="2" max="15" step="1" style="width:80px" />
                            <span>s</span>
                            <p class="description"><?php echo esc_html(ai_chatboot_ms_t('admin_voice_silence_desc')); ?></p>
                        </td>
                    </tr>
                </table>

                <!-- Handoff — Sazināšanās ar operatoru -->
                <h2 style="margin-top:30px">✋ <?php echo esc_html(ai_chatboot_ms_t('admin_handoff_title')); ?></h2>
                <p class="description" style="margin-bottom:12px"><?php echo esc_html(ai_chatboot_ms_t('admin_handoff_desc')); ?></p>
                <table class="form-table">
                    <tr>
                        <th><?php echo esc_html(ai_chatboot_ms_t('admin_handoff_enabled')); ?></th>
                        <td>
                            <label>
                                <input type="checkbox" name="ai_chatboot_ms_handoff_enabled" value="1" <?php checked(get_option('ai_chatboot_ms_handoff_enabled', '0'), '1'); ?> />
                                <?php echo esc_html(ai_chatboot_ms_t('admin_handoff_enabled_desc')); ?>
                            </label>
                        </td>
                    </tr>
                    <tr>
                        <th><?php echo esc_html(ai_chatboot_ms_t('admin_handoff_context')); ?></th>
                        <td>
                            <label>
                                <input type="checkbox" name="ai_chatboot_ms_handoff_context" value="1" <?php checked(get_option('ai_chatboot_ms_handoff_context', '1'), '1'); ?> />
                                <?php echo esc_html(ai_chatboot_ms_t('admin_handoff_context_desc')); ?>
                            </label>
                        </td>
                    </tr>
                    <tr>
                        <th><?php echo esc_html(ai_chatboot_ms_t('admin_handoff_methods')); ?></th>
                        <td>
                            <?php
                            $handoff_methods = json_decode(get_option('ai_chatboot_ms_handoff_methods', '[]'), true);
                            if (!is_array($handoff_methods)) $handoff_methods = [];
                            $method_types = [
                                'email'     => ai_chatboot_ms_t('admin_handoff_email'),
                                'whatsapp'  => ai_chatboot_ms_t('admin_handoff_whatsapp'),
                                'telegram'  => ai_chatboot_ms_t('admin_handoff_telegram'),
                                'facebook'  => ai_chatboot_ms_t('admin_handoff_facebook'),
                                'instagram' => ai_chatboot_ms_t('admin_handoff_instagram'),
                                'tiktok'    => ai_chatboot_ms_t('admin_handoff_tiktok'),
                                'custom'    => ai_chatboot_ms_t('admin_handoff_custom'),
                            ];
                            ?>
                            <div id="msai-handoff-methods">
                                ...
                                <div class="msai-handoff-row" style="display:flex;gap:8px;align-items:center;margin-bottom:6px">
                                    ...
                                    <input type="text" class="msai-ho-value" value="<?php echo esc_attr($m['value'] ?? ''); ?>" placeholder="<?php echo esc_attr(ai_chatboot_ms_t('admin_handoff_value_ph')); ?>" style="width:220px" />
                                    <input type="text" class="msai-ho-label" value="<?php echo esc_attr($m['label'] ?? ''); ?>" placeholder="<?php echo esc_attr(ai_chatboot_ms_t('admin_handoff_label_ph')); ?>" style="width:200px" />
                                    <button type="button" class="button msai-ho-remove" title="<?php echo esc_attr(ai_chatboot_ms_t('admin_handoff_remove')); ?>">&times;</button>
                                </div>
                                <?php endforeach; ?>
                            </div>
                            <input type="hidden" name="ai_chatboot_ms_handoff_methods" id="msai-handoff-json" value="<?php echo esc_attr(wp_json_encode($handoff_methods)); ?>" />
                            <button type="button" class="button" id="msai-handoff-add" style="margin-top:6px">+ <?php echo esc_html(ai_chatboot_ms_t('admin_handoff_add')); ?></button>
                            <p class="description" style="margin-top:6px"><?php echo esc_html(ai_chatboot_ms_t('admin_handoff_methods_desc')); ?></p>
                        </td>
                    </tr>
                </table>
                ...
                (function(){
                    ...
                    function addRow(type, value, label) {
                        ...
                        sel += '</select>';
                        row.innerHTML = sel
                            + '<input type="text" class="msai-ho-value" value="'+(value||'')+'" placeholder="<?php echo esc_js(ai_chatboot_ms_t('admin_handoff_value_ph')); ?>" style="width:220px" />'
                            + '<input type="text" class="msai-ho-label" value="'+(label||'')+'" placeholder="<?php echo esc_js(ai_chatboot_ms_t('admin_handoff_label_ph')); ?>" style="width:200px" />'
                            + '<button type="button" class="button msai-ho-remove" title="<?php echo esc_js(ai_chatboot_ms_t('admin_handoff_remove')); ?>">&times;</button>';
                ...
                <table class="form-table">
                    <tr>
                        <th><?php echo esc_html(ai_chatboot_ms_t('admin_gdpr_notice')); ?></th>
                        <td>
                            <?php $gdpr_notice = get_option('ai_chatboot_ms_gdpr_notice', ''); ?>
                            <textarea name="ai_chatboot_ms_gdpr_notice" rows="3" style="width:100%;max-width:500px"><?php echo esc_textarea($gdpr_notice); ?></textarea>
                            <p class="description"><?php echo esc_html(ai_chatboot_ms_t('admin_gdpr_notice_desc')); ?></p>
                        </td>
                    </tr>
                </table>
                ...
                <h2>🏷️ <?php echo esc_html(ai_chatboot_ms_t('admin_wl_title')); ?></h2>
                <p><?php echo esc_html(ai_chatboot_ms_t('admin_wl_desc')); ?></p>

                <table class="form-table">
                    <tr>
                        <th><?php echo esc_html(ai_chatboot_ms_t('admin_wl_name')); ?></th>
                        <td>
                            <input type="text" name="ai_chatboot_ms_wl_name" value="<?php echo esc_attr(get_option('ai_chatboot_ms_wl_name', '')); ?>" style="width:300px" placeholder="<?php echo esc_attr(ai_chatboot_ms_t('admin_wl_name_ph')); ?>" />
                            <p class="description"><?php echo esc_html(ai_chatboot_ms_t('admin_wl_name_desc')); ?></p>
                        </td>
                    </tr>
                    <tr>
                        <th><?php echo esc_html(ai_chatboot_ms_t('admin_wl_icon')); ?></th>
                        <td>
                            <input type="text" name="ai_chatboot_ms_wl_icon" value="<?php echo esc_attr(get_option('ai_chatboot_ms_wl_icon', '')); ?>" style="width:120px" placeholder="💬" />
                            <p class="description"><?php echo esc_html(ai_chatboot_ms_t('admin_wl_icon_desc')); ?></p>
                        </td>
                    </tr>
                    <tr>
                        <th><?php echo esc_html(ai_chatboot_ms_t('admin_wl_welcome')); ?></th>
                        <td>
                            <input type="text" name="ai_chatboot_ms_wl_welcome" value="<?php echo esc_attr(get_option('ai_chatboot_ms_wl_welcome', '')); ?>" style="width:100%;max-width:500px" placeholder="<?php echo esc_attr(ai_chatboot_ms_t('admin_wl_welcome_ph')); ?>" />
                            <p class="description"><?php echo esc_html(ai_chatboot_ms_t('admin_wl_welcome_desc')); ?></p>
                        </td>
                    </tr>
                    <tr>
                        <th><?php echo esc_html(ai_chatboot_ms_t('admin_wl_admin_name')); ?></th>
                        <td>
                            <input type="text" name="ai_chatboot_ms_wl_admin_name" value="<?php echo esc_attr(get_option('ai_chatboot_ms_wl_admin_name', '')); ?>" style="width:300px" placeholder="Bootflow Shop Assist" />
                            <p class="description"><?php echo esc_html(ai_chatboot_ms_t('admin_wl_admin_name_desc')); ?></p>
                        </td>
                    </tr>
                    <tr>
                        <th><?php echo esc_html(ai_chatboot_ms_t('admin_wl_powered_by')); ?></th>
                        <td>
                            <label>
                                <input type="checkbox" name="ai_chatboot_ms_wl_powered_by" value="1" <?php checked(get_option('ai_chatboot_ms_wl_powered_by', '0'), '1'); ?> />
                                <?php echo esc_html(ai_chatboot_ms_t('admin_wl_powered_by_desc')); ?>
                            </label>
                        </td>
                    </tr>
                </table>
            ...
            <div style="margin-top:20px;padding:12px 16px;background:#f0f6fc;border:1px solid #c3c4c7;border-left:4px solid #72aee6;">
                ...
                <ul>
                    ...
                    if ($json_path && file_exists($json_path)) {
                        ...
                        echo '<li>' . esc_html(sprintf(ai_chatboot_ms_t('admin_products_info'), $product_count, $file_size)) . '</li>';
                    }
                    ?>
                </ul>

                <p><strong><?php echo esc_html(ai_chatboot_ms_t('admin_voice_notes')); ?></strong></p>
                <ul>
                    <li><strong><?php echo esc_html(ai_chatboot_ms_t('admin_browser_speech')); ?></strong> Chrome, Edge, Safari (<?php echo esc_html(ai_chatboot_ms_t('admin_requires_https')); ?>)</li>
                    <li><strong><?php echo esc_html(ai_chatboot_ms_t('admin_mic_permissions')); ?></strong> <?php echo esc_html(ai_chatboot_ms_t('admin_mic_first_time')); ?></li>
                    <li><strong><?php echo esc_html(ai_chatboot_ms_t('admin_language_support')); ?></strong> <?php echo esc_html(ai_chatboot_ms_t('admin_languages_list')); ?></li>
                    <li><strong><?php echo esc_html(ai_chatboot_ms_t('admin_if_not_working')); ?></strong> <?php echo esc_html(ai_chatboot_ms_t('admin_check_console')); ?> <code>debugSpeechRecognition()</code></li>
                </ul>
            </div>
            ...
            <h2>📦 <?php echo esc_html(ai_chatboot_ms_t('admin_ie_title')); ?></h2>
            <p><?php echo esc_html(ai_chatboot_ms_t('admin_ie_desc')); ?></p>
            ...
            if (isset($_GET['msai_import']) && wp_verify_nonce($import_notice_nonce, 'ai_chatboot_ms_notice')) {
                ...
                if ($status === 'success') {
                    ...
                    echo '<div class="notice notice-error is-dismissible"><p>❌ ' . esc_html(ai_chatboot_ms_t('admin_ie_invalid')) . '</p></div>';
                }
            }
            ?>
            ...
            <div style="display:flex;gap:24px;flex-wrap:wrap;margin-top:12px;">
                ...
                <div style="flex:1;min-width:280px;padding:16px;background:#f9f9f9;border:1px solid #ddd;border-radius:8px;">
                    <h3 style="margin-top:0;">⬇️ <?php echo esc_html(ai_chatboot_ms_t('admin_ie_export')); ?></h3>
                    <p style="font-size:13px;color:#666;"><?php echo esc_html(ai_chatboot_ms_t('admin_ie_export_desc')); ?></p>
                    <form method="post" action="<?php echo esc_url(admin_url('admin-post.php')); ?>">
                        <?php wp_nonce_field('ai_chatboot_ms_export_settings'); ?>
                        <input type="hidden" name="action" value="ai_chatboot_ms_export_settings">
                        <button type="submit" class="button button-primary">⬇️ <?php echo esc_html(ai_chatboot_ms_t('admin_ie_export_btn')); ?></button>
                    </form>
                </div>

                <!-- Import -->
                <div style="flex:1;min-width:280px;padding:16px;background:#fff8f0;border:1px solid #f0d0a0;border-radius:8px;">
                    <h3 style="margin-top:0;">⬆️ <?php echo esc_html(ai_chatboot_ms_t('admin_ie_import')); ?></h3>
                    <p style="font-size:13px;color:#666;"><?php echo esc_html(ai_chatboot_ms_t('admin_ie_import_desc')); ?></p>
                    <form method="post" action="<?php echo esc_url(admin_url('admin-post.php')); ?>" enctype="multipart/form-data">
                        <?php wp_nonce_field('ai_chatboot_ms_import_settings'); ?>
                        <input type="hidden" name="action" value="ai_chatboot_ms_import_settings">
                        <input type="file" name="settings_file" accept=".json" required style="margin-bottom:8px;">
                        <br>
                        <button type="submit" class="button" onclick="return confirm('<?php echo esc_js(ai_chatboot_ms_t('admin_ie_confirm')); ?>');">⬆️ <?php echo esc_html(ai_chatboot_ms_t('admin_ie_import_btn')); ?></button>
                    </form>
                </div>
            </div>
            ...
            <h2><?php echo esc_html(ai_chatboot_ms_t('admin_content_export')); ?></h2>
            <p><?php echo esc_html(ai_chatboot_ms_t('admin_export_desc')); ?></p>
            <p><em><?php echo esc_html(ai_chatboot_ms_t('admin_export_auto')); ?></em></p>

            <form method="post" action="<?php echo esc_url(admin_url('admin-post.php')); ?>">
                <?php wp_nonce_field('export_products'); ?>
                <input type="hidden" name="action" value="export_products">
                <p>
                    <input type="submit" class="button button-primary" value="<?php echo esc_attr(ai_chatboot_ms_t('admin_export_button')); ?>">
                </p>
            </form>

            <?php if ($products_json_url): ?>
                <p><strong><?php echo esc_html(ai_chatboot_ms_t('admin_json_available')); ?></strong> <a href="<?php echo esc_url($products_json_url); ?>" target="_blank"><?php echo esc_url($products_json_url); ?></a></p>
            <?php endif; ?>
        <?php
    }
    ...
    public function handle_export_settings() {
        ...
        check_admin_referer('ai_chatboot_ms_export_settings');

        $option_keys = [
            'ai_chatboot_ms_language',
            'ai_chatboot_ms_excluded_tags',
            'ai_chatboot_ms_color_palette',
            'ai_chatboot_ms_custom_primary',
            'ai_chatboot_ms_custom_text',
            'ai_chatboot_ms_custom_bg',
            'ai_chatboot_ms_color_details',
            'ai_chatboot_ms_color_compare',
            'ai_chatboot_ms_color_cart',
            'ai_chatboot_ms_font',
            'ai_chatboot_ms_font_size',
            'ai_chatboot_ms_font_style',
            'ai_chatboot_ms_voice_mode',
            'ai_chatboot_ms_voice_silence',
            'ai_chatboot_ms_show_default_starters',
            'ai_chatboot_ms_gdpr_notice',
            'ai_chatboot_ms_auto_contact',
            'ai_chatboot_ms_handoff_enabled',
            'ai_chatboot_ms_handoff_context',
            'ai_chatboot_ms_handoff_methods',
            'ai_chatboot_ms_wl_name',
            'ai_chatboot_ms_wl_icon',
            'ai_chatboot_ms_wl_welcome',
            'ai_chatboot_ms_wl_admin_name',
            'ai_chatboot_ms_wl_powered_by',
            'ai_chatboot_ms_custom_responses',
            'ai_chatboot_ms_starter_questions',
        ];
    ...
    private function render_custom_responses_tab() {
        $items = get_option('ai_chatboot_ms_custom_responses', []);
        ...
        <div class="msai-cr-wrap">
            <h2><?php echo esc_html(ai_chatboot_ms_t('admin_tab_responses')); ?></h2>
            ...
            <form method="post" action="<?php echo esc_url(admin_url('admin-post.php')); ?>" id="msai-cr-form">
                ...
                <div id="msai-cr-list">
                    ...
                    <div class="msai-cr-item" data-index="0">
                        <button type="button" class="msai-cr-remove" onclick="this.parentElement.remove(); msaiCrRenum();" title="<?php echo esc_attr(ai_chatboot_ms_t('admin_cr_delete')); ?>">✕ <?php echo esc_html(ai_chatboot_ms_t('admin_cr_delete')); ?></button>
                        <label><span class="msai-cr-num">1</span> <?php echo esc_html(ai_chatboot_ms_t('admin_cr_keywords_label')); ?></label>
                        <input type="text" name="cr_keywords[]" class="msai-cr-keywords" placeholder="<?php echo esc_attr(ai_chatboot_ms_t('admin_cr_placeholder_kw')); ?>">
                        <label><?php echo esc_html(ai_chatboot_ms_t('admin_cr_response_label')); ?></label>
                        <textarea name="cr_response[]" class="msai-cr-response" placeholder="<?php echo esc_attr(ai_chatboot_ms_t('admin_cr_placeholder_resp')); ?>"></textarea>
                    </div>
                    <?php else: ?>
                        <?php foreach ($items as $i => $item): ?>
                        <div class="msai-cr-item" data-index="<?php echo (int) $i; ?>">
                            <button type="button" class="msai-cr-remove" onclick="this.parentElement.remove(); msaiCrRenum();" title="<?php echo esc_attr(ai_chatboot_ms_t('admin_cr_delete')); ?>">✕ <?php echo esc_html(ai_chatboot_ms_t('admin_cr_delete')); ?></button>
                            <label><span class="msai-cr-num"><?php echo (int) $i + 1; ?></span> <?php echo esc_html(ai_chatboot_ms_t('admin_cr_keywords_label')); ?></label>
                ...
                <button type="button" class="msai-cr-add" onclick="msaiCrAdd()"><?php echo esc_html(ai_chatboot_ms_t('admin_cr_add_new')); ?></button>

                <p style="margin-top:16px">
                    <?php submit_button(ai_chatboot_ms_t('admin_cr_save'), 'primary', 'submit', false); ?>
                </p>
            </form>
        </div>
        ...
        <script>
        var msaiCrLabels = {
            del: <?php echo wp_json_encode(ai_chatboot_ms_t('admin_cr_delete')); ?>,
            kw:  <?php echo wp_json_encode(ai_chatboot_ms_t('admin_cr_keywords_label')); ?>,
            resp: <?php echo wp_json_encode(ai_chatboot_ms_t('admin_cr_response_label')); ?>
        };
        function msaiCrAdd() {
    ...
    private function render_starter_questions_section() {
        ...
        <style>
            ...
            .msai-sq-prod-list { display: flex; flex-wrap: wrap; gap: 6px; margin-bottom: 8px; }
        </style>
        ...
        <div class="msai-sq-wrap">
            ...
            <form method="post" action="<?php echo esc_url(admin_url('admin-post.php')); ?>" id="msai-sq-form">
                ...
                <div id="msai-sq-list">
                    <?php if (empty($items)): ?>
                        <p style="color:#666;font-style:italic;"><?php echo esc_html(ai_chatboot_ms_t('admin_sq_empty')); ?></p>
                    <?php else: ?>
                        <?php foreach ($items as $i => $item): ?>
                        <div class="msai-sq-item" data-index="<?php echo (int) $i; ?>">
                            ...
                            <label><span class="msai-sq-num"><?php echo (int) $i + 1; ?></span> <?php echo esc_html(ai_chatboot_ms_t('admin_sq_question_label')); ?></label>
                            <input type="text" name="sq_question[]" class="msai-sq-question" value="<?php echo esc_attr($item['question']); ?>" placeholder="<?php echo esc_attr(ai_chatboot_ms_t('admin_sq_question_ph')); ?>">

                            <label><?php echo esc_html(ai_chatboot_ms_t('admin_sq_type_label')); ?></label>
                            ...
                            <div class="msai-sq-block msai-sq-b-text" style="<?php echo esc_attr($item['type'] !== 'text' ? 'display:none' : ''); ?>">
                                <label><?php echo esc_html(ai_chatboot_ms_t('admin_sq_text_label')); ?></label>
                            ...
                            <div class="msai-sq-block msai-sq-b-search" style="<?php echo esc_attr($item['type'] !== 'search' ? 'display:none' : ''); ?>">
                                <label><?php echo esc_html(ai_chatboot_ms_t('admin_sq_search_text_label')); ?></label>
                                <input type="text" name="sq_search_text[]" value="<?php echo esc_attr($item['search_text'] ?? ''); ?>" placeholder="<?php echo esc_attr(ai_chatboot_ms_t('admin_sq_search_text_ph')); ?>">

                                <label><?php echo esc_html(ai_chatboot_ms_t('admin_sq_search_mode_label')); ?></label>
                                <div class="msai-sq-radio-group">
                                    <label><input type="radio" name="sq_search_mode[<?php echo (int) $i; ?>]" value="keyword" <?php checked(($item['search_mode'] ?? 'keyword'), 'keyword'); ?> onchange="msaiSqSearchMode(this)"> <?php echo esc_html(ai_chatboot_ms_t('admin_sq_mode_keyword')); ?></label>
                                    <label><input type="radio" name="sq_search_mode[<?php echo (int) $i; ?>]" value="category" <?php checked(($item['search_mode'] ?? ''), 'category'); ?> onchange="msaiSqSearchMode(this)"> <?php echo esc_html(ai_chatboot_ms_t('admin_sq_mode_category')); ?></label>
                                    <label><input type="radio" name="sq_search_mode[<?php echo (int) $i; ?>]" value="sale" <?php checked(($item['search_mode'] ?? ''), 'sale'); ?> onchange="msaiSqSearchMode(this)"> <?php echo esc_html(ai_chatboot_ms_t('admin_sq_mode_sale')); ?></label>
                                    <label><input type="radio" name="sq_search_mode[<?php echo (int) $i; ?>]" value="new" <?php checked(($item['search_mode'] ?? ''), 'new'); ?> onchange="msaiSqSearchMode(this)"> <?php echo esc_html(ai_chatboot_ms_t('admin_sq_mode_new')); ?></label>
                                </div>

                                <div class="msai-sq-kw-wrap" style="<?php echo esc_attr(($item['search_mode'] ?? 'keyword') !== 'keyword' ? 'display:none' : ''); ?>">
                                    <input type="text" name="sq_search_keyword[]" value="<?php echo esc_attr($item['search_keyword'] ?? ''); ?>" placeholder="<?php echo esc_attr(ai_chatboot_ms_t('admin_sq_keyword_ph')); ?>">
                                </div>
                                ...
                                <label><?php echo esc_html(ai_chatboot_ms_t('admin_sq_products_label')); ?></label>
                                ...
                                <div class="msai-sq-prod-search-wrap">
                                    <input type="text" class="msai-sq-prod-input" placeholder="<?php echo esc_attr(ai_chatboot_ms_t('admin_sq_products_ph')); ?>" oninput="msaiSqProdSearch(this, <?php echo (int) $i; ?>)" autocomplete="off">
                            ...
                            <div class="msai-sq-block msai-sq-b-faq" style="<?php echo esc_attr($item['type'] !== 'faq' ? 'display:none' : ''); ?>">
                                <label><?php echo esc_html(ai_chatboot_ms_t('admin_sq_faq_page_label')); ?></label>
                                <select name="sq_faq_page[]">
                                    <option value="0"><?php echo esc_html(ai_chatboot_ms_t('admin_sq_faq_page_none')); ?></option>
                ...
                <button type="button" class="msai-sq-add" onclick="msaiSqAdd()"><?php echo esc_html(ai_chatboot_ms_t('admin_sq_add_new')); ?></button>

                <p style="margin-top:16px">
                    <?php submit_button(ai_chatboot_ms_t('admin_sq_save'), 'primary', 'submit', false); ?>
                </p>
            </form>
        </div>
        ...
        <script>
        var msaiSqLabels = {
            question: <?php echo wp_json_encode(ai_chatboot_ms_t('admin_sq_question_label')); ?>,
            question_ph: <?php echo wp_json_encode(ai_chatboot_ms_t('admin_sq_question_ph')); ?>,
            ...
            search_mode: <?php echo wp_json_encode(ai_chatboot_ms_t('admin_sq_search_mode_label')); ?>,
            mode_keyword: <?php echo wp_json_encode(ai_chatboot_ms_t('admin_sq_mode_keyword')); ?>,
            mode_category: <?php echo wp_json_encode(ai_chatboot_ms_t('admin_sq_mode_category')); ?>,
            mode_sale: <?php echo wp_json_encode(ai_chatboot_ms_t('admin_sq_mode_sale')); ?>,
        ...
        var msaiWcCatsAllLabel = <?php echo wp_json_encode(ai_chatboot_ms_t('admin_sq_all_subcats')); ?>;
        ...
        function msaiSqProdSearch(input, idx) {
            ...
            msaiProdTimer = setTimeout(function() {
                ...
                xhr.open('GET', msaiAdminAjax + '?action=ai_chatboot_ms_admin_product_search&nonce=' + msaiAdminNonce + '&q=' + encodeURIComponent(q));
                xhr.onload = function() {
    ...
    public function maybe_redirect_after_activation() {
        if (!get_transient('ai_chatboot_ms_activated')) {
            return;
        }
